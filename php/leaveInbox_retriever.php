<?php
    ...
    $sql = "SELECT HR_LeaveRequests.employeeID, HR_LeaveRequests.timestamp FROM HR_LeaveRequests JOIN HR_Users ON HR_LeaveRequests.employeeID=HR_Users.employeeID WHERE HR_LeaveRequests.signed='1' AND HR_Users.manager = '" .$currentUser. "'";
