...
/*!
  ...
  @throws SUPPersistenceException
 */
+ (HR_SuiteJobManagement*)load:(int64_t)id;
/*!
  @method 
...
/*!
  @method 
  @abstract Return a list of HR_SuiteJobManagement objects
  @discussion
  @throws SUPPersistenceException
 */
...
@end
typedef SUPObjectList HR_SuiteJobManagementList;

// internal methods declaration, only used by generated code.
@interface HR_SuiteJobManagement(internal)
