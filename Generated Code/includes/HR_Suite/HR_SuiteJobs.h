...
@interface HR_SuiteJobs : SUPAbstractEntityRBS<SUPMobileBusinessObject, SUPClassWithMetaData>
{
@private
    int32_t _id;
    NSNumber* _jobNumber;
    NSString* _jobName;
    NSNumber* _totalHours;
...
@property(retain,nonatomic) NSNumber* totalHours;
...
/*!
  @method 
  @abstract Return a list of HR_SuiteJobs objects
  @discussion
  @throws SUPPersistenceException
 */
...
@end
typedef SUPObjectList HR_SuiteJobsList;

// internal methods declaration, only used by generated code.
@interface HR_SuiteJobs(internal)
