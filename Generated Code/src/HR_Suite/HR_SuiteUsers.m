...
+ (SUPObjectList*)findAll:(int32_t)skip take:(int32_t)take
{
	...
	_selectSQL = [[[NSMutableString alloc] initWithCapacity:352] autorelease];
	[_selectSQL appendString:@" x.\"a\",x.\"b\",x.\"c\",x.\"d\",x.\"e\",x.\"f\",x.\"g\",x.\"h\",x.\"i\",x.\"j\",x.\"l\",x.\"m\",x.\"n\",x.\"o\",x.\"q\",x.\"_pf\",x.\"_pc\",x.\"_rp\",x.\"_rf\",x.\"p\",x.\"_rc\",x.\"_ds\" FROM \"hr_suite_1_0_users\" x where (((x.\"_pf\" = 1 or not exists (select x_os.\"p\" from \"hr_suite_1_0_users_os\" x_os where x_os."
	                               "\"p\" = x.\"p\"))))"];
...
+ (HR_SuiteUsers*)findByPrimaryKey:(int32_t)id_
{
	NSMutableString *sql = nil;
	NSMutableString *_selectSQL = nil;
	_selectSQL = [[[NSMutableString alloc] initWithCapacity:377] autorelease];
	[_selectSQL appendString:@"SELECT x.\"a\",x.\"b\",x.\"c\",x.\"d\",x.\"e\",x.\"f\",x.\"g\",x.\"h\",x.\"i\",x.\"j\",x.\"l\",x.\"m\",x.\"n\",x.\"o\",x.\"q\",x.\"_pf\",x.\"_pc\",x.\"_rp\",x.\"_rf\",x.\"p\",x.\"_rc\",x.\"_ds\" FROM \"hr_suite_1_0_users\" x WHERE (((x.\"_pf\" = 1 or not exists (select x_os.\"p\" from \"hr_suite_1_0_users_os\" x_os where"
	                               " x_os.\"p\" = x.\"p\")))) and ( x.\"a\" = ?)"];
