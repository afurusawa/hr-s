...
@implementation HR_SuitePackagePropertiesMetaData

+ (HR_SuitePackagePropertiesMetaData*)getInstance
{
    return [[[HR_SuitePackagePropertiesMetaData alloc] init] autorelease];
}
...
- (id)init
{
    if (self = [super init]) {
		...
		self.table = @"hr_suite_1_0_packageproperties";
