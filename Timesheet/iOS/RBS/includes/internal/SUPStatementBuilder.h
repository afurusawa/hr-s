...
@interface SUPStatementBuilder : NSObject {
    @private
    SUPStringList*          _sb;
    SUPDatabaseMetaData*    _dbMetaData;
    NSMutableDictionary*    _entityMetaDataMap;
    NSMutableDictionary*    _subQueries;
    SUPObjectList*          _mdList;
    SUPObjectList*          _parameters;
}
@property(readwrite, retain, nonatomic) SUPDatabaseMetaData* dbMetaData;

+ (SUPStatementBuilder*)getInstance;
+ (SUPQueryResultSet*)executeQuery:(id<SUPConnectionWrapper>)cw:(SUPDatabaseMetaData*)dbMetaData:(SUPQuery*)query;
