...
@property(readwrite, assign) BOOL cidHasChanged;
...
- (void)changeCIDWithFlag:(BOOL)setChangeFlag;
...
- (void)dispatchReceivedMessage:(SUPJsonMessage*)message:(BOOL)isAyncNotification;
