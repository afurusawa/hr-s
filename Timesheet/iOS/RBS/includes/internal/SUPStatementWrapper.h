...
- (void)setBigBinary:(SUPInt)_index_1:(SUPString)_name_2:(id)_value_3;
- (void)setBigString:(SUPInt)_index_1:(SUPString)_name_2:(id)_value_3;
- (void)setNullableBigBinary:(SUPInt)_index_1:(SUPString)_name_2:(id)_value_3;
- (void)setNullableBigString:(SUPInt)_index_1:(SUPString)_name_2:(id)_value_3;
