...
typedef enum
{
    ...
    SUPSynchronizationStatus_ASYNC_REPLAY_UPLOADED = 6,
    SUPSynchronizationStatus_ASYNC_REPLAY_COMPLETED = 7,
    SUPSynchronizationStatus_STARTING_ON_NOTIFICATION = 8
...
/*!
 ...
 @discussion 
 */
+ (SUPSynchronizationStatusType)STARTING;
/*!
 @method     
 ...
 @discussion 
 */
+ (SUPSynchronizationStatusType)UPLOADING;
/*!
 @method     
 ...
 @discussion 
 */
+ (SUPSynchronizationStatusType)DOWNLOADING;
/*!
 @method     
 ...
 @discussion 
 */
+ (SUPSynchronizationStatusType)FINISHING;
/*!
 @method     
 ...
 @discussion 
 */
+ (SUPSynchronizationStatusType)ERROR;
