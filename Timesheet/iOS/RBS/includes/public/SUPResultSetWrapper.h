...
/*!
 @method     
 @abstract   Retrieve SUPBigBinary type data with given index and given name from the result set.
 @discussion 
 @param _index_1 - index in sql query list.
 @param -name_2 - name of the column.
 @result SUPBigBinary type of data.
 */
- (SUPBigBinary*)getBigBinary:(SUPInt)_index_1:(SUPString)_name_2;

/*!
 @method     
 @abstract   Retrieve SUPBigString type data with given index and given name from the result set.
 @discussion 
 @param _index_1 - index in sql query list.
 @param -name_2 - name of the column.
 @result SUPBigString type of data.
 */
- (SUPBigString*)getBigString:(SUPInt)_index_1:(SUPString)_name_2;
...
/*!
 ...
 @param _index_1 - index in sql query list.
 @param -name_2 - name of the column.
 @result SUPBigBinary type of nullable data.
 */
- (SUPBigBinary*)getNullableBigBinary:(SUPInt)_index_1:(SUPString)_name_2;
...
/*!
 ...
 @param _index_1 - index in sql query list.
 @param -name_2 - name of the column.
 @result SUPBigString type of nullable data.
 */
- (SUPBigString*)getNullableBigString:(SUPInt)_index_1:(SUPString)_name_2;

/*!
    @method     
    @abstract   Move to first row in result set.            
    @discussion 
...
/*!
    @method     
    @abstract   Move to previous row in result set.            
    @discussion 
    @result True on success, otherwise false.
*/
- (SUPBoolean)previous;
...
/*!
    @method     
    @abstract   Move to last row in result set.            
    @discussion 
    @result True on success,otherwise false.
*/
- (SUPBoolean)last;
...
/*!
    @method     
    @abstract   Move to before first row in result set.            
    @discussion 
    @result True on success, otherwise false.
*/
- (SUPBoolean)beforeFirst;

/*!
    @method     
    @abstract   Move to after last row in result set.            
    @discussion 
    @result True on success, otherwise false.
*/
- (SUPBoolean)afterLast;
...
/*!
    @method     
    @abstract   move the cursor by offset rows from the current cursor position          
    @discussion 
    @param offset - offset from current cursor position.
    @result true on success, otherwise false.
*/
- (SUPBoolean)relative: (int)offset;

/*!
    @method     
    @abstract   move the cursor to the specified position          
    @discussion 
    @result true on success, otherwise false.
*/
- (SUPBoolean)absolute: (int)index;
...
- (SUPBoolean)isNull:(SUPInt)index:(SUPString)name;
@end
