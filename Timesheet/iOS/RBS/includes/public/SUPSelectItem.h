...
+ (SUPSelectItem*)newInstance DEPRECATED_ATTRIBUTE NS_RETURNS_NON_RETAINED;
- (SUPSelectItem*)init;
...
/*!
 @property     
 @abstract   The as alias value.
 @discussion
 */
@property(readwrite, retain, nonatomic) SUPNullableString asAlias;

/*!
 @property     
 @abstract   The sub query.
 @discussion
 */
@property(readwrite, retain, nonatomic) SUPQuery *query;

/*!
 @property     
 @abstract   The full name.
 @discussion
 */
@property(readwrite, retain, nonatomic) SUPString fullName;
