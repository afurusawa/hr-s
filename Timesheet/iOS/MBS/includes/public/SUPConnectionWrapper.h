...
/*!
 ...
 @abstract    The SUPConnectionWrapper protocol provides a common interface for database connections.  The clientrt library for iPhone provides 
              an internal implementation of this protocol that wraps a ULtraLite database connection.
 @discussion  
 */
...
/*!
 @method     
 @abstract   return the active connection profile 
 @discussion
 @result    Handler of connection porfile.
 */
