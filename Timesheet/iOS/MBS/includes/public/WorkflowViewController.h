...
+ (Workflow*)workflowWithModuleId:(NSUInteger)moduleId withModuleVersion:(NSUInteger)moduleVersion scope:(bool)bFromInstalledWorkflows;
...
- (void)workflowDidClose:(NSInteger)msgId withModuleId:(NSInteger)moduleId withModuleVersion:(NSInteger)moduleVersion;
