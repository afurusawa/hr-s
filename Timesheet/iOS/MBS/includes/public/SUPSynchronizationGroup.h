...
- (int32_t)interval;
- (void) setInterval:(int32_t)_interval;
/*!
 @property     
 @abstract   The interval value which indicates the frequency to check data change.
 @discussion 
 */
@property(readwrite,assign,nonatomic) int32_t interval;

/*!
 @method     
 @abstract   Save this synchronization group.
 @discussion 
 */
- (void)save;
...
/*!
 @method
 @abstract  Returns the names of the entities in this synchronization group.
 @discussion
 */
