...
@synthesize selectedDay, selectedDate, selectedUser, currentDate, employeeName, selectedIndex;
...
- (void)customizeAppearance
{
    ...
    UIImage *bg1 = [[UIImage imageNamed:@"ts.topappbar-bg"] resizableImageWithCapInsets:UIEdgeInsetsMake(0, 0, 0, 0)];
    UIImage *bg2 = [[UIImage imageNamed:@"ts.topappbar-bg"] resizableImageWithCapInsets:UIEdgeInsetsMake(0, 0, 0, 0)];
    [[UINavigationBar appearance] setBackgroundImage:bg1 forBarMetrics:UIBarMetricsDefault];
    [[UINavigationBar appearance] setBackgroundImage:bg2 forBarMetrics:UIBarMetricsLandscapePhone];
}
...
//    [window makeKeyAndVisible];
    ...
    [[JMC sharedInstance] configureJiraConnect:@"http://68.225.30.194:8100/"
                                    projectKey:@"HRSUITE"
                                        apiKey:@"14e42627-ccb3-4f61-893c-2ed04e81a221"];
