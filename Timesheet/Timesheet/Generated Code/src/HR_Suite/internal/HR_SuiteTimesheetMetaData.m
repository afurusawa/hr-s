...
- (id)init
{
    if (self = [super init]) {
		...
		[o_createByDay_0 setIsDelete:NO]; 		
 		SUPOperationMetaData* o_delete_0 = [SUPOperationMetaData createOperationMetaData:5:(SUPString)@"delete":[SUPDataType forName:@"void"]:true];
		[o_delete_0 setIsStatic:NO];
		[o_delete_0 setIsCreate:NO];
		[o_delete_0 setIsUpdate:NO];
		[o_delete_0 setIsDelete:YES]; 		
 		SUPOperationMetaData* o_findAll_0 = [SUPOperationMetaData createOperationMetaData:6:(SUPString)@"findAll":[SUPDataType forName:@"Timesheet*"]:true];
		[o_findAll_0 setIsStatic:YES];
		[o_findAll_0 setIsCreate:NO];
		[o_findAll_0 setIsUpdate:NO];
		[o_findAll_0 setIsDelete:NO]; 		
 		SUPOperationMetaData* o_findByPrimaryKey_1 = [SUPOperationMetaData createOperationMetaData:7:(SUPString)@"findByPrimaryKey":[SUPDataType forName:@"Timesheet"]:true];
	  	{
		...
		[o_findByPrimaryKey_1 setIsDelete:NO]; 		
 		SUPOperationMetaData* o_findStatsFromDay_3 = [SUPOperationMetaData createOperationMetaData:8:(SUPString)@"findStatsFromDay":[SUPDataType forName:@"Timesheet*"]:true];
	  	{
			SUPObjectList *parameters_list = nil;
		...
		[o_findStatsFromDay_3 setIsDelete:NO]; 		
 		SUPOperationMetaData* o_findByEmployeeIDandDate_2 = [SUPOperationMetaData createOperationMetaData:9:(SUPString)@"findByEmployeeIDandDate":[SUPDataType forName:@"Timesheet*"]:true];
	  	{
			SUPObjectList *parameters_list = nil;
		...
		[o_findByEmployeeIDandDate_2 setIsDelete:NO]; 		
 		SUPOperationMetaData* o_findByEmployeeAndSubmission_2 = [SUPOperationMetaData createOperationMetaData:10:(SUPString)@"findByEmployeeAndSubmission":[SUPDataType forName:@"Timesheet*"]:true];
	  	{
			SUPObjectList *parameters_list = nil;
		...
		[o_findByEmployeeAndSubmission_2 setIsDelete:NO]; 		
 		SUPOperationMetaData* o_refresh_0 = [SUPOperationMetaData createOperationMetaData:11:(SUPString)@"refresh":[SUPDataType forName:@"void"]:true];
		[o_refresh_0 setIsStatic:NO];
		[o_refresh_0 setIsCreate:NO];
		[o_refresh_0 setIsUpdate:NO];
		[o_refresh_0 setIsDelete:NO]; 		
 		SUPOperationMetaData* o__pk_0 = [SUPOperationMetaData createOperationMetaData:12:(SUPString)@"_pk":[SUPDataType forName:@"long?"]:true];
		[o__pk_0 setIsStatic:NO];
		[o__pk_0 setIsCreate:NO];
		[o__pk_0 setIsUpdate:NO];
		[o__pk_0 setIsDelete:NO]; 		
 		SUPOperationMetaData* o_submitPending_0 = [SUPOperationMetaData createOperationMetaData:13:(SUPString)@"submitPending":[SUPDataType forName:@"void"]:true];
		...
		[o_submitPending_0 setIsDelete:NO]; 		
 		SUPOperationMetaData* o_cancelPending_0 = [SUPOperationMetaData createOperationMetaData:14:(SUPString)@"cancelPending":[SUPDataType forName:@"void"]:true];
		...
		[o_cancelPending_0 setIsDelete:NO]; 		
 		SUPOperationMetaData* o_submitPendingOperations_0 = [SUPOperationMetaData createOperationMetaData:15:(SUPString)@"submitPendingOperations":[SUPDataType forName:@"void"]:true];
		...
		[o_submitPendingOperations_0 setIsDelete:NO]; 		
 		SUPOperationMetaData* o_cancelPendingOperations_0 = [SUPOperationMetaData createOperationMetaData:16:(SUPString)@"cancelPendingOperations":[SUPDataType forName:@"void"]:true];
		...
		[o_cancelPendingOperations_0 setIsDelete:NO]; 		
 		SUPOperationMetaData* o_save_0 = [SUPOperationMetaData createOperationMetaData:17:(SUPString)@"save":[SUPDataType forName:@"void"]:true];
		[o_save_0 setIsStatic:NO];
		[o_save_0 setIsCreate:NO];
		[o_save_0 setIsUpdate:NO];
		[o_save_0 setIsDelete:NO]; 		
 		SUPOperationMetaData* o_findWithQuery_1 = [SUPOperationMetaData createOperationMetaData:18:(SUPString)@"findWithQuery":[SUPDataType forName:@"Timesheet*"]:true];
	  	{
			SUPObjectList *parameters_list = nil;
		...
		[o_findWithQuery_1 setIsDelete:NO]; 		
 		SUPOperationMetaData* o_getSize_1 = [SUPOperationMetaData createOperationMetaData:19:(SUPString)@"getSize":[SUPDataType forName:@"int"]:true];
	  	{
			SUPObjectList *parameters_list = nil;
		...
		[o_getSize_1 setIsDelete:NO]; 		
  		...
  		SUPObjectList *operations = [SUPObjectList listWithCapacity:19];
