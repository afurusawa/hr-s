...
@interface HR_SuiteKeyGeneratorPK : SUPAbstractStructure<SUPClassWithMetaData>
{
@private
    NSString* _remoteId;
    int64_t _batchId;
...
@end
typedef SUPObjectList HR_SuiteKeyGeneratorPKList;

// internal methods declaration, only used by generated code.
@interface HR_SuiteKeyGeneratorPK(internal)
