...
/*!
 @protocol
 @abstract    A callback protocol that will be invoked when any database event occurs. A default callback handler @link //apple_ref/occ/cl/SUPDefaultCallbackHandler SUPDefaultCallbackHandler @/link is provided, which is basically does nothing. Application programmers should implement a custom implementation of this protocol to register for the interested events. The callback will be invoked on the thread that is processing the event.  The callback handler should be registered with the generated package database class, and may also be registered with generated MBO classes.
 @discussion  
 */
