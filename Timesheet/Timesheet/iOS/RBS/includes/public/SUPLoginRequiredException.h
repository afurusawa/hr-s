...
/*!
 @class SUPLoginRequiredException
 @abstract   This exception is thrown when the client application does not call beginOnlineLogin methods to login to the server.
 @discussion 
 */
...
+ (SUPLoginRequiredException*)newInstance DEPRECATED_ATTRIBUTE NS_RETURNS_NON_RETAINED;
/*!
 @method     
