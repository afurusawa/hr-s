...
/*!
 ...
 @result The initalized SUPObjectList.
 */
+ (SUPObjectList*)newInstance DEPRECATED_ATTRIBUTE NS_RETURNS_NON_RETAINED;
...
/*!
 @method     
 @abstract   Add all elements of the given list to self.
 @discussion 
 @param the list to copy objects from.
 */
- (void)addAll:(SUPObjectList*)list;
- (void)addAllFromArray:(NSMutableArray*)list;
/*!
 @method
