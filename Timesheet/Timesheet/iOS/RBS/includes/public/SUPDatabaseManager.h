...
@class SUPConnectionSyncParams;

@protocol SUPSyncStatusListener;
...
@property (nonatomic, retain) id<SUPReadWriteLockManager> rwlock;
...
//- (void)synchronize:(id<SUPConnectionWrapper>)cw;
//- (void)synchronize:(id<SUPConnectionWrapper>)cw withListener:(id<SUPSyncStatusListener>)listener;
- (void)synchronize:(id<SUPConnectionWrapper>)cw :(SUPConnectionSyncParams*)syncParams;
- (void)synchronize:(id<SUPConnectionWrapper>)cw withParams:(SUPConnectionSyncParams*)syncParams withListener:(id<SUPSyncStatusListener>)listener withMBOMap:(NSMutableDictionary*)tableMBOs;
/*!
    @method     
...
//- (void)setConnectionSyncParams:(id<SUPConnectionWrapper>)connectionwrapper:(SUPConnectionSyncParams*)syncParams;
@end
