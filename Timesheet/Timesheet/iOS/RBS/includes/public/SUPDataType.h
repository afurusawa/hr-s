...
enum SUPDataType_Names {
    SUPDataType_VOID = 0,
    SUPDataType_OBJECT = 1,
    SUPDataType_BOOLEAN = 2,
    SUPDataType_STRING = 3,
    SUPDataType_BINARY = 4,
    SUPDataType_CHAR = 5,
    SUPDataType_BYTE = 6,
    SUPDataType_SHORT = 7,
    SUPDataType_INT = 8,
    SUPDataType_LONG = 9,
    SUPDataType_INTEGER = 10,
    SUPDataType_DECIMAL = 11,
    SUPDataType_FLOAT = 12,
    SUPDataType_DOUBLE = 13,
    SUPDataType_DATE = 14,
    SUPDataType_TIME = 15,
    SUPDataType_DATE_TIME = 16,
    SUPDataType_LIST = 17
};
 ...
 */
+ (SUPDataType*)newInstance DEPRECATED_ATTRIBUTE NS_RETURNS_NON_RETAINED;
