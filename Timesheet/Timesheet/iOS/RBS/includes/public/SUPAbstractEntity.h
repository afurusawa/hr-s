...
@interface SUPAbstractEntity(internal)
...
+ (void)streamImportHandler:(SUPJsonStreamParser*)parser;
+ (SUPJsonObject*)importFromStream:(SUPJsonStreamParser*)parser;
#if 0
...
- (void)evict:(int)days;
/*abstract*/ - (long)getRowId:(BOOL)isPending;
- (void)dealloc;
/*abstract*/ - (void)writeToMBOReplayStream:(SUPMBOReplayStream*)stream:(int)flags;
- (void)writeChildListToMBOReplayStream:(SUPMBOReplayStream*)stream:(SUPObjectList*)entityList:(int)flags;
