 ...
 */
@interface SUPBigString : SUPBigData
{
...
/*!
 ...
 @discussion Throws @link //apple_ref/occ/cl/SUPObjectNotSavedException SUPObjectNotSavedException @/link if this SUPBigString object is an attribute of an entity that has not yet been created in the database.
...
/*!
 @method     
 @abstract   Returns a new instance of SUPBigString.
 @result The SUPBigString.
 @discussion 
 */
+ (SUPBigString*)getInstance;
...
/*!
 ...
 @discussion Any previous contents of the value will be discarded. Throws @link //apple_ref/occ/cl/SUPObjectNotSavedException SUPObjectNotSavedException @/link if this SUPBigString object is an attribute of an entity that has not yet been created in the database.
...
/*!
 @method
 @abstract Reads and returns up to 'length' characters (fewer if end of stream is reached). 
 ...
 @throws @link //apple_ref/occ/cl/SUPStreamNotOpenException SUPStreamNotOpenException @/link
 */
- (NSString*)read:(int64_t)length;

/*!
 @method
 @abstract Reads a single character from the stream. Returns -1 if end of stream has been reached. 
 @discussion Throws @link //apple_ref/occ/cl/SUPStreamNotOpenException SUPStreamNotOpenException @/link if the stream is not open for reading.
...
/*!
 ...
 @throws @link //apple_ref/occ/cl/SUPWriteOverLengthException SUPWriteOverLengthException @/link
 */
- (void)writeChar:(unichar)data;

/*!
 @method copyToFile
 @abstract Writes the contents of this BigString object to a file, in UTF8 string format.
...
/*!
 @method copyFromFile
 @abstract Replaces the contents of this BigString object with the contents of the file passed in.  The file is expected to contain UTF8 encoded string data.
