...
typedef enum
{
    ...
    SUPAttributeTest_IN = 19,
    SUPAttributeTest_NOT_IN = 20,
    SUPAttributeTest_EXISTS = 21,
    SUPAttributeTest_NOT_EXISTS = 22
...
+ (SUPAttributeTest*)newInstance DEPRECATED_ATTRIBUTE NS_RETURNS_NON_RETAINED;
/*!
 @method     
...
/*!
 @method     
 @abstract   Returns the constant value for filter type IN.
 @result The filter type.
 @discussion 
 */
+ (SUPInt)IN;
...
/*!
 @method     
 @abstract   Returns the constant value for filter type NOT_IN.
 @result The filter type.
 @discussion 
 */
+ (SUPInt)NOT_IN;
...
/*!
 @method     
 @abstract   Returns the constant value for filter type EXISTS.
 @result The filter type.
 @discussion 
 */
+ (SUPInt)EXISTS;
...
/*!
 @method     
 @abstract   Returns the constant value for filter type NOT_EXISTS.
 @result The filter type.
 @discussion 
 */
+ (SUPInt)NOT_EXISTS;
...
+ (SUPAttributeTest*)notEndsWith:(SUPString)a:(id)v;
+ (SUPAttributeTest*)in:(SUPString)a:(id)v;
+ (SUPAttributeTest*)notIn:(SUPString)a:(id)v;
+ (SUPAttributeTest*)exists:(SUPString)a:(id)v;
+ (SUPAttributeTest*)notExists:(SUPString)a:(id)v;
- (void)dealloc;
