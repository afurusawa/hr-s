...
#ifndef __SUP_ERROR_H__
#define __SUP_ERROR_H__
#define SUPErrorDomain @"SUPErrorDomain"
#define SUCCESS 0
...
NSDictionary * generateUserInfo(NSString* mbo, NSString* value, NSString* operation);
#endif
