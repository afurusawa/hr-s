...
@interface SUPLocalKeyGenerator : NSObject
...
- (void) copyAll:(SUPLocalKeyGenerator*)entity;
- (void) refresh;
- (SUPLocalKeyGenerator*)load:(SUPKeyGeneratorPK*)key;
- (void) save;
- (SUPLocalKeyGenerator*) find:(SUPKeyGeneratorPK*)key;
- (void) create;
- (void) update;
- (void) delete;
- (void)dealloc;
+ (SUPJsonObject*) toJson:(SUPLocalKeyGenerator*)obj;
- (SUPJsonObject*) toJson;
+ (SUPObjectList*) fromJSONList:(SUPJsonArray*)array;
+ (SUPJsonArray*) toJSONList:(SUPObjectList*) list;
+ (SUPLocalKeyGenerator*) fromJson:(SUPJsonObject*)json;
