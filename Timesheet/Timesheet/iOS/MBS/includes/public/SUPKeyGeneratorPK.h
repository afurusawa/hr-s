...
@interface SUPKeyGeneratorPK : NSObject
{
...
@interface SUPKeyGeneratorPK (internal)
+ (SUPKeyGeneratorPK*) fromJson:(SUPJsonObject*)json;
+ (SUPJsonObject*) toJson:(SUPKeyGeneratorPK*)obj;
