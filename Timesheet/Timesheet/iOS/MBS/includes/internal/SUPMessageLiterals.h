...
extern NSString* MSGHDR_APPID;
extern NSString* MSGHDR_APPNAME;
extern NSString* MSGHDR_PROPNAME;
extern NSString* MSGHDR_PROPVALUE;
extern NSString* MSGHDR_SUPOBJ_CMD;
extern NSString* MSG_HEADER_REMOTE_ID;
...
extern NSString* SMETHOD_CONFIGURATION_CHANGED;
extern NSString* SMETHOD_REREGISTER;
extern NSString* SMETHOD_ASYNCREPLAYCOMPLETED;
extern NSString* SMETHOD_TCN;
extern NSString* MSG_CONTENT_USER_CONTEXT;
extern NSString* MSG_CONTENT_SYNCHRONIZATION_GROUP;

// suffix and prefix string literals
extern NSString* _FAILURE;
extern NSString* _SUCCESS;
