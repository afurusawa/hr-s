...
- (void)viewDidLoad
{
    ...
    [searchBar setBackgroundImage:[UIImage imageNamed:@"ts-manager-addnewemployee-subtitle-bg.png"]];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    [cell.position setFont:[UIFont fontWithName:@"ProximaNova-Regular" size:10]];
    
    //text color when highlighted
    cell.name.highlightedTextColor = [UIColor colorWithRed:42/255.0 green:106/255.0 blue:136/255.0 alpha:1];
